...
helm upgrade featurebyte-oss featurebyte-oss \
    ...
    --repo=https://featurebyte.github.io/helm-charts \
    --set jwt_secret="${JWT_SECRET}" \
    --set enc_secret="${ENC_SECRET}"
...
| **encryption_secret**                                             | string | ""                             | secret used to encrypt password                                                                         |
| **jwt_secret**                                                    | string | ""                             | secret used to generate jwt tokens                                                                      |
...
| **featurebyte.api.image.tag**                                     | string | !!Unset                        | defaults to App.ChartVersion                                                                            |
...
| **featurebyte.worker.image.tag**                                  | string | !!Unset                        | defaults to App.ChartVersion                                                                            |
...
| **s3.minio.persistence.storageClass**                             | string | null                           |                                                                                                         |
| **s3.external.url**                                               | string | !!Unset                        | s3 external URL to be specified. e.g. https://storage.googleapis.com/                                   |
| **s3.external.region**                                            | string | !!Unset                        |                                                                                                         |
| **s3.external.accessKey**                                         | string | !!Unset                        | s3 HMAC accessKey                                                                                       |
| **s3.external.secretKey**                                         | string | !!Unset                        | s3 HMAC secretKey                                                                                       |
| **s3.external.bucketName**                                        | string | !!Unset                        |                                                                                                         |
...
| **mongodb.communityOperator.persistence.storageClass**            | string | null                           |                                                                                                         |
...
| **mongodb.external.connectionStr**                                | string | mongodb://:external:27017/     | external mongodb connectionStr (note the mongodb used must have a replicaset architecture)              |
...
| **redis.standalone.persistence.storageClass**                     | string | null                           |                                                                                                         |
...
| **ingress.host**                                                  | string |                                | ingress host to connect to featurebyte api service                                                      |
